            ...
            <div class="container">
                ...
                <div class="prof-content col-md-9 col-xs-12">
                    ...
                    <div class="min-body col-xs-12">
                        <form action="{{ route('Products.myStore.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group col-md-6 col-xs-12">
                                <h5>السعر القديم</h5>
                                <input type="text" name="old_price" value="{{old('old_price')}}" class="form-control" value="399 جنية">
                            </div>

                            <div class="form-group col-md-6 col-xs-12">
                                <h5>السعر الجديد</h5>
                                <input type="text" name="new_price" value="{{old('new_price')}}" class="form-control" value="399 جنية">
                            </div>

                            <div class="form-group col-md-6 col-xs-12">
                                <h5>نسبه الخصم</h5>
                                <input type="text" name="percent_of_discount" value="{{old('percent_of_discount')}}" class="form-control" value="17%">
                            </div>
                            <div class="form-group col-md-6 col-xs-12">
                                <h5>حاله المنتج</h5>
                                <select class="form-control">
                                    <option name="product_status" value="{{old('product_status')}}" disabled>اختر حاله السلعه</option>
                                    <option>جديدة</option>
                            ...
                            <div class="form-group col-md-12 col-xs-12">
                                <h5>الوصف</h5>
                                <textarea name="product_disc" value="{{old('product_disc')}}" class="form-control"></textarea>
                            </div>
                            <div class="min-head col-xs-12">
                                <h3>صور المنتج</h3>
                            </div>
                                ...
                                <div class="f-img">
                                    <label>
                                        <img src="{{ url('assets/front') }}/images/camera.png" alt=""
                                            class="pc">
                                        <input type="file" name="image_one" value="{{old('image_one')}}"
                            ...
                            <div class="form-group ad-images col-md-8 col-xs-12">
                                ...
                                <div class="f-img">
                                    <label>
                                        <img src="{{ url('assets/front') }}/images/camera.png" alt=""
                                            class="pc">
                                        <input type="file" name="image_two" value="{{old('image_two')}}"
