        ...
        <div class="cover-bottom col-xs-12">
            ...
            <div class="st-actions">
                <a href="{{route('notification')}}">
                    الاشعارات {{auth()->user()->Notifications->count()}}
                ...
                <div class="prof-content col-md-9 col-xs-12">
                    <div class="min-head col-xs-12">
                        <h3>@lang('dashboard.categories')
                            <span> @lang('dashboard.edit_categories')</span>
                        </h3>
                    </div>
                    <div class="min-body col-xs-12">
                        <form action="{{route('category.update',$category->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group prime-img col-md-4 col-xs-12">
                                <h5> @lang('dashboard.category_photo')
                                </h5>
                                <div class="f-img">
                                    <label>
                                        ...
                                        @else
                                            <img src="{{ url('Uploads/categories') }}/{{ $category->category_photo}}" id="blah"
                                                alt="your image">
                                        @endif
                            ...
                            <div class="form-group col-md-12 col-xs-12">
                                ...
                                <button type="submit" class="btn">@lang('dashboard.edit_categories')</button>
                            </div>
                        </form>
                    </div>
                </div>
